        ...
        case GGML_OP_CPY:
            {
                ...
                if ((src0_type == GGML_TYPE_F32 && (src1_type == GGML_TYPE_TURBO3_0 || src1_type == GGML_TYPE_TURBO4_0)) ||
                    ((src0_type == GGML_TYPE_TURBO3_0 || src0_type == GGML_TYPE_TURBO4_0) && src1_type == GGML_TYPE_F32)) {
                    return true;
                }
