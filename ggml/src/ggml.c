    ...
    switch (type) {
        ...
        case GGML_TYPE_TURBO3_0:
            ...
            for (int64_t i = 0; i < nrows; ++i) {
                quantize_row_turbo3_0_ref(src + start + i*n_per_row,
                        (block_turbo3_0 *) ((char *) dst + (start_row + i)*row_size), n_per_row);
            }
        ...
        case GGML_TYPE_TURBO4_0:
            ...
            for (int64_t i = 0; i < nrows; ++i) {
                quantize_row_turbo4_0_ref(src + start + i*n_per_row,
                        (block_turbo4_0 *) ((char *) dst + (start_row + i)*row_size), n_per_row);
            }
            result = nrows * row_size;
            break;
