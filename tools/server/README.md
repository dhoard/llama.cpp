...
| `--incremental-tokenization, --no-incremental-tokenization` | reuse tokenized plain-text prompts on exact matches or at tokenizer control-token boundaries (default: enabled)<br/>(env: LLAMA_ARG_INCREMENTAL_TOKENIZATION) |
